<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true"
    CodeBehind="Complaint_Reports.aspx.cs" Inherits="TestWebservice.Complaint_Reports" %>
            ...
            <div class="container">
                ...
                <div class="panel panel-default" style="padding: 10px;">
                    <div class="panel-body">
                        <legend>Complaints Reports</legend>
                        <div class="row">
                            <div class="col-s-6">
                            ...
                            <div class="col-s-6">
                                <div class="row" style="padding-top: 6px;">
                                    <div class="col-s-2">
                                        <label for="ddlComplaintType">
                                            Complaints Type
                                        </label>
                                    </div>
                                   <div class="col-s-5"><div class="input-group">
                                        <asp:DropDownList ID="ddlComplaintType" runat="server" class="form-control">
                                        </asp:DropDownList><span class="input-group-addon add-on"  ><span class="glyphicon glyphicon-chevron-down"></span>
                                    </div></div>
                                </div>
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <div class="col-s-5">
                                        <div class="input-group">
                                            <asp:TextBox ID="txtfromdate" class="form-control" autocomplete="off"
                                                placeholder="From Date" runat="server"></asp:TextBox>
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <div class="col-s-5">
                                        <div class="input-group">
                                            <asp:TextBox ID="txttodate"  class="form-control" autocomplete="off"
                        ...
                        <div class="row" style="padding-top: 15px;">
                            ...
                            <asp:Label ID="lblcount" Style="margin-left: 60%;"  runat="server" Font-Italic="True" ForeColor="#0066CC" Font-Size="Medium"></asp:Label>
