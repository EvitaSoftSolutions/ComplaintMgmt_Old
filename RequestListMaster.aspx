<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="RequestListMaster.aspx.cs" Inherits="TestWebservice.RequestListMaster" %>
...
<div class="container">
    ...
    <div style="margin-top: 10px;" class="col-sm-6  panel panel-default">
                    <div class="panel-body">
                        ...
                        <legend>Request List Master</legend>
                        <div class="row">
                            <div class="col-s-12">
                                <div style="padding-top: 5px;" class="row">
                                    ...
                                    <div class="col-s-8">
                                        <asp:TextBox ID="txtComplaintType" runat="server" 
                                            ...
                                            placeholder="Enter Request Type" MaxLength="40"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <asp:GridView ID="grdComplaintList"  AutoGenerateColumns="False" runat="server"  OnRowCommand="gvList_RowCommand" data-page-size="4">
                <Columns>
                    ...
                    <asp:TemplateField Visible="true" HeaderText="Type">
                        <ItemTemplate>
                            <asp:Label ID="lblCompType" runat="Server" Text='<%# Eval("Requests") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Update" Visible="true">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkUpdate" Text="Update" runat="server" CommandName="Select"  CommandArgument='<%# Eval("Requests")+ ";" +Eval("RequestListID")+ ";" +Eval("IsForNewConsumer")%>'> </asp:LinkButton>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Delete" Visible="true">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkRemove" Text="Delete" runat="server" CommandName="Remove" CommandArgument='<%# Eval("Requests")+ ";" +Eval("RequestListID")+ ";" +Eval("IsForNewConsumer")%>'></asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle CssClass="GridViewItem" />
                        <HeaderStyle CssClass="GridViewHeader" />
                    </asp:TemplateField>
