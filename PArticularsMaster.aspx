<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="PArticularsMaster.aspx.cs" Inherits="TestWebservice.PArticularsMaster" %>
...
<div class="col-sm-12 col-md-offset-3">
    ...
    <div style="margin-top: 10px;" class="col-sm-6  panel panel-default">
                    <div class="panel-body">
                        ...
                        <legend>Particulars Master</legend>
                        <div class="row">
                            <div class="col-s-12">
                                <div style="padding-top: 5px;" class="row">
                                    ...
                                    <div class="col-s-8">
                                        <asp:TextBox ID="txtName" runat="server" 
                                            ...
                                            placeholder="Enter Particular Name" MaxLength="40"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-s-12">
                                <div style="padding-top: 5px;" class="row">
                                    <div class="col-s-4">
                                        <label for="txtName">
                                            Particular Rate</label>
                                    </div>
                                     <div class="col-s-8">
                                        <asp:TextBox ID="txtContact" runat="server" 
                                            style="text-transform:uppercase;" class="form-control" 
                                            placeholder="Enter Particular Rate" MaxLength="40"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div style="margin-top: 10px;" class="col-sm-6  panel panel-default">
        <div class="panel-body">
            <legend>Added Particulars</legend>
            ...
            <asp:GridView ID="grdComplaintList"  AutoGenerateColumns="False" runat="server"  OnRowCommand="gvList_RowCommand" data-page-size="4">
                <Columns>
                    ...
                    <asp:TemplateField Visible="true" HeaderText="Name">
                        <ItemTemplate>
                            <asp:Label ID="lblCompType" runat="Server"  Text='<%# Eval("particular") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField Visible="true" HeaderText="Contact">
                        <ItemTemplate>
                           <%-- <asp:CheckBox ID="chkforNewConsumer"  runat="server" />--%>
                            <asp:Label ID="lblforNewConsumer" runat="Server" Text='<%# Eval("rate") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Update" Visible="true">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkUpdate" Text="Update" runat="server" CommandName="Select" CommandArgument='<%# Eval("particular")+ ";" +Eval("ID")+ ";" +Eval("rate")%>'></asp:LinkButton>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Delete" Visible="true">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkRemove" Text="Delete" runat="server" CommandName="Remove" CommandArgument='<%# Eval("particular")+ ";" +Eval("ID")+ ";" +Eval("rate")%>'></asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle CssClass="GridViewItem" />
                        <HeaderStyle CssClass="GridViewHeader" />
                    </asp:TemplateField>
