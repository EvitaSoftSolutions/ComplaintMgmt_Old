<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" Inherits="TestWebservice.Request_Reports" Codebehind="Request_Reports.aspx.cs" %>
            ...
            <div class="container">
                ...
                <div class="panel panel-default" style="padding: 10px;">
                    <div class="panel-body">
                        <legend>Request Reports</legend>
                        <div class="row">
                            <div class="col-s-6">
                                
                                <div class="row" style="display:none; padding-top: 6px;">
                                    <div class="col-s-3">
