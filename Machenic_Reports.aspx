<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="Machenic_Reports.aspx.cs" Inherits="TestWebservice.Machenic_Reports" %>
            ...
            <div class="container">
                ...
                <div class="panel panel-default" style="padding: 10px;">
                    <div class="panel-body">
                        <legend>Machenic Reports</legend>
                        <div class="row">
                            <div class="col-s-6">
                                ...
                                <div class="row" style="padding-top: 6px;">
                                    ...
                                    <div class="col-s-8"><div class="input-group">
                                       <asp:DropDownList ID="ddlReportType" AutoPostBack="true" class="form-control" runat="server" 
                                            onselectedindexchanged="ddlReportType_SelectedIndexChanged">
                                                    <asp:ListItem>Collection Report</asp:ListItem>
                                                    <asp:ListItem>Stock Used Report</asp:ListItem>
                                ...
                                <div class="row" style="padding-top: 6px;">
                                 ...
                                 <div class="row" runat="server" id="DivParticulars" visible="false" style="padding-top: 6px;">
                                    <div class="col-s-3">
                                        <label for="ddlParticulars">
                                            Particulars </label>
                                    </div>
                                    <div class="col-s-8"><div class="input-group">
                                        <asp:DropDownList ID="ddlParticulars"  runat="server" class="form-control">
                                        </asp:DropDownList><span class="input-group-addon add-on"  ><span class="glyphicon glyphicon-chevron-down"></span>
                                    </div></div>
                                </div>
