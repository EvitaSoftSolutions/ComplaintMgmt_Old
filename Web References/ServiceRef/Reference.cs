...
namespace TestWebservice.ServiceRef {
    ...
    public partial class TestService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public TestService() {
            this.Url = global::TestWebservice.Properties.Settings.Default.TestWebservice_ServiceRef_TestService;
        ...
        /// <remarks/>
        public void SigninAsync(string Username, string Pwd) {
            this.SigninAsync(Username, Pwd, null);
        }
        
        /// <remarks/>
        public void SigninAsync(string Username, string Pwd, object userState) {
